...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Agri price yield forecasting  (In progressing)",
      description:
        "The Agricultural Price and Yield Forecasting System is a web-based platform designed to analyze historical agricultural data and support crop planning decisions. The system aims to provide price forecasting, yield analysis, and basic risk assessment tools for farmers and agricultural officers.This project is currently under development, and the present work focuses on the frontend implementation only, built using Next.js and Tailwind CSS. The backend, database integration, and predictive modeling components are still in progress.",
      image: "/APFSY.JPG",
      tags: ["NextJS", "Tailwind CSS", "TypeScript"],
      MoreUrl: "https://agri-price-yield-forecasting.vercel.app/",
      githubUrl: "https://github.com/Rmutt2005/agri-price-yield-forecasting",
    },
  ];
